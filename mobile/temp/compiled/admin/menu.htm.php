...
<li class="button" key="14_school" name="menu">
	...
	<a href="javascript:void(0);"><em id="h1_14_school"></em>商之翼学院<span id="fa_14_school"></span></a></li>

   <li class="dropdown" id="14_school">

   <ul>
        <li class="dropdown"><a href="http://www.68ecshop.com/study/index.htm" target="_blank">ECShop在线手册</a></li>

        <li class="dropdown"><a href="http://www.68ecshop.com/article_cat-26.html" target="_blank">ECShop视频教程</a></li>

        <li class="dropdown"><a href="http://www.68ecshop.com/article_cat-31.html" target="_blank">ECShop安装使用</a></li>

        <li class="dropdown"><a href="http://bbs.68ecshop.com/forum.php" target="_blank">ECShop交流论坛</a></li>
