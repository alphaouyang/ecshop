...
<div class="">
	<script language="javascript" src="http://www.jntoo.com/website_load.php?name=<?php echo $this->_var['website_name']; ?>"></script>   <!-- 检查是否有新的插件 -->
</div>
...
?>
    <tr align="center">
        ...
        <td><?php if (! $this->_var['val']['install']): ?><a href="website.php?act=install&type=<?php echo $this->_var['val']['type']; ?>"><?php echo $this->_var['lang']['install']; ?></a><?php else: ?>
            ...
            <script language="javascript" src="http://www.jntoo.com/website_update.php?type=<?php echo $this->_var['val']['type']; ?>"></script> <!-- 插件更新 -->
        </td>
    </tr>
